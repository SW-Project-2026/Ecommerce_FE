...
const USER = { name: '김다온', grade: 'GOLD', points: '12,500', coupons: 3 }
      ...
      <aside className="myp-sidebar">
        <div className="myp-sb-profile">
          ...
          <div className="myp-sb-stats">
            <div>
              <div className="myp-sb-stat-val">{USER.points}P</div>
              <div className="myp-sb-stat-label">포인트</div>
            </div>
            <div>
        ...
        <nav className="myp-sb-menu">
          {MENU.map(m => (
            <div
              key={m.key}
              className={`myp-sb-menu-item${tab === m.key ? ' active' : ''}`}
          ...
          <div
            className="myp-sb-menu-item myp-sb-logout"
